monogatari.script({
    ...
    'English': {
        'Start': [
            ...
            '...',
            'show character ash 1 at left with spriteSlideInLeft flipped',
            ...
            'show character ash 1 at left with flipped',
            ...
            'show character ash 1 at center with flipped',
        ...
        'ch1_beforeClosetMoppingScrubSoft': [
            'show character ash 7 with flipped',
            ...
            'play sound wet-squish-4',
            'show character ash 1 at right with flipped',
        ...
        'ch1_closetHideChoiceRunFaster': [
            ...
            'hide image ch1-hide-bitedrew',
            'show image ch1-hide-relievedrew',
            'To your relief, the warden can be heard leaving the room, a small click of the lock audible before his footsteps fade off into the distance.',
            ...
            'hide image ch1-hide-relievedrew',
            'hide image ch1-hide-sushley',
            'TODO: SHOW BACKGROUND FOR BALCONY HERE',
        ...
        'ch1_postWardenGloatYesLeyley': [
            ...
            'and: ... What?',
            'ash: Leyley!',
            'ash: You\'re supposed to be calling me Leyley!',
            'ash: Andy and Leyley and The Escape from the Coffin!',
            'and: No, no, we\'re not doing this.',
            'ash: Why not?!',
            'ash: Why can\'t we?!',
            'ash: Why can\'t you?!',
            'ash: Didn\'t we agree to this, Andy?!',
            'ash: Last night while you were in my bed failing to compartmentalize!',
            'and: No!',
            'and: "Whatever" isn\'t agreeing to jack shit.',
            'ash: Yes it is!',
            'and: How, exactly?',
            'ash: "Whatever" is tacid acceptance!',
            'ash: You don\'t get to be non-committal and then complain later that you don\'t like a decision!',
            'ash: You had the chance to say no and you didn\'t!',
            'and: Fine! You want a no?! Here\'s a no!',
            'and: Fuck off with that Andy and Leyley shit!',
            'ash: Ugh, why are you like this?',
            'and: Why are YOU like this?!',
            'ash: Oh, I\'m sorry, is a little nickname too much to ask from you?',
            'ash: Well, excuse me for being a demanding nagging bitch!',
            'and: You\'re certainly acting like one!',
            'and: And I told you to stop calling me Andy! We\'re not kids anymore!',
            'TODO: Finish this train of thought! SORRY GAME ISN\'T DONE YET!',
            'end'
        ],
        'ch1_postWardenGloatNoLeyley': [
            'In a rare moment of restraint, you choose not to make a big deal out of being called Ashley instead of Leyley.',
            'Andrew will not appreciate this, even though you\'re doing this for him.',
            'end'
        ],
        ...
        'ch1_postWardenBond': [
            ...
            'show character ash 2 at right',
            'ash: Aww, Andy~ Look at you - all sweaty and dramatic!',
            'show character ash 2 at right with spriteBounce',
            ...
            'and: ... and thanks for cleaning up the blood.',
